...
# specific array structure in the form of:
...
# Note that we invert the predictions before calculating error scores to
# ensure that performance is reported in the same units
